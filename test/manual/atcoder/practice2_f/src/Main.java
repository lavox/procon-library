...
public class Main {
	...
	public void solve() {
		...
		long[] c = Convolution.convolution(a, b, MOD);
		print(c, SPACE);
	}
...
class Convolution {
	...
	private static final long i1 = inv(MOD2 * MOD3, MOD1);
	private static final long i2 = inv(MOD1 * MOD3, MOD2);
	private static final long i3 = inv(MOD1 * MOD2, MOD3);
